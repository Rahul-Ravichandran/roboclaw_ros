...
class EncoderOdom:
    ...
    def update(self, enc_front_left, enc_front_right, enc_back_left, enc_back_right):
        ...
        dist_front_left = front_left_ticks / self.TICKS_PER_METER
        dist_front_right = front_right_ticks / self.TICKS_PER_METER
        dist_back_left = back_left_ticks / self.TICKS_PER_METER
        dist_back_right = back_right_ticks / self.TICKS_PER_METER
...
class Node:
    def __init__(self):
        ...
        self.TICKS_PER_METER = float(rospy.get_param("~tick_per_meter", "89478.2"))
